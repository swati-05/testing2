...
function Trade_surrender() {
  return (
    <>
      <div class="container mx-auto">
        <div class="flex h-full">
            <div class=" shadow-2xl p-6 rounded-2xl border-2 border-gray-50" style={{"backgroundColor":"#ff4c51"}}>
                <div class="flex flex-col h-12 w-12">
                    <div>
                        <h2 class="font-bold text-white  text-xs mt-0 mr-8">SURRENDER</h2>
                    </div>
                    <div>
...
export default Trade_surrender