    ...
    return (
        <>
            <div className='grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 gap-1 container mx-auto '>
                <div className='col-span-8 bg-sky-100 rounded-lg '>
                    <div className=' rounded-md shadow-lg p-2'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3  gap-1 container mx-auto p-2'>
                            ...
                            <div className='bg-white rounded-r-3xl rounded-t-3xl p-4 shadow-lg'>
                                ...
                                <span ><button className='text-xs font-mono  text-stone-50 shadow-lg px-6 py-1 rounded-md bg-teal-400 hover:bg-teal-500 ml-10 mt-2 '>TAKE ME IN</button></span>
                            </div>
                            <div className='bg-white rounded-b-3xl rounded-l-3xl p-4 shadow-lg'>
