    ...
    return (
        <>
            <div className=' border-gray-100 border shadow-md'>
                <div className='flex flex-row bg-white p-2 border-b-2 border-gray-100 '>
                    <div className=' -mt-6'>
                        <img src='https://cdn-icons-png.flaticon.com/512/4108/4108042.png' className='h-12 w-12 bg-sky-200 p-1' />
                    </div>
                    <h1 className='text-xs ml-2'>Notification</h1>
                    <br />
                ...
                <div className='bg-white p-6 '>
                    <div className='divide-y'>
                        ...
                        <h1 className='text-xs -mt-5 ml-1'>water due date on 12/12/2022</h1>
                ...
                <div className='bg-white p-6'>
                    <div className='divide-y'>
                        ...
                        <h1 className='text-xs -mt-5 ml-1'>Your saf application has been approved</h1>
                        {/* <button className='text-sm float-right bg-blue-200 px-3 py-0 ml-2 shadow-lg rounded-sm'>Pay</button> */}
                    </div>
