...
function Trade_newLicense() {
  return (
    <>
    <Link to="/newapply"> <div class="container mx-auto">
        <div class="flex h-full">
            <div class=" shadow-2xl p-6 rounded-2xl border-2 border-gray-50" style={{"backgroundColor":"#56ca00"}}>
                <div class="flex flex-col h-12 w-12">
                    <div>
                        <h2 class="font-bold text-white text-center text-xs mt-0">NEW LICENSE</h2>
                    </div>
                    <div>
...
export default Trade_newLicense