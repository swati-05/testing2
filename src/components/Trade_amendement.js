...
function Trade_amendement() {
  return (
    <>
     <div class="container mx-auto">
        <div class="flex h-full">
            <div class=" shadow-2xl p-6 rounded-2xl border-2 border-gray-50" style={{"backgroundColor":"#ffb400"}}>
                <div class="flex flex-col h-12 w-12">
                    <div>
                        <h2 class="  font-bold text-white text-center text-xs mt-0 mr-0">AMENDEMENT</h2>
                    </div>
                    <div>
...
export default Trade_amendement