...
function CitizenObjectionFormIndex() {
    ...
    return (
        ...
        <div className='w-10/12 ml-48'>
            ...
            <div className={`${animateform1} transition-all relative`}><CitizenObjectionEntryForm collectFormDataFun={collectAllFormData} submitFun={submitButtonToggle} toastFun={notify} /></div>
