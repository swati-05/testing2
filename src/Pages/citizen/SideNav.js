                    ...
                    <div className={`${navWidth} h-screen bg-slate-50 transition-all duration-1000 ml-48 drop-shadow-md rounded-md overflow-hidden`}>
                        <div>
                            ...
                            <div class="grid  gap-2 grid-cols-2 mt-2 ">
                                ...
                                <Link to="/citizenDashboard/CitizenAccountSettingw"> <div class=" flex flex-col w-24 h-20 mt-4 ml-3 items-center bg-white rounded-md justify-center shadow-xl cursor-pointer">
