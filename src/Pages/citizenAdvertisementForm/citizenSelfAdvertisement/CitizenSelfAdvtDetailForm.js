...
const CitizenSelfAdvtDetailForm = () => {
                    ...
                    <div className='shadow-lg rounded-lg'>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className='grid place-items-center'>
                                {submitData
                                    ?
                                    <Tooltip title="You have Updated Earlier" placement="right" arrow>
                                        <button
                                            type="submit"
                                            className='my-5 px-5 py-2 hover:img-src font-bold bg-blue-500 text-white rounded-md'
                                            disabled={isSubmitting}>
                                            Updated <MdVerified size={20} className='inline -mt-1 ml-1' />
                                            {/* <img className='ml-1 inline h-8 rounded-full' src={rightImg} alt="Right" /> */}
                                        </button>
                                    </Tooltip>
